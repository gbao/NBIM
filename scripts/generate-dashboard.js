...
class DashboardGenerator {
  ...
  async generateDashboardHtml(data) {
    ...
    try {
      ...
      // Duplicate keys in template: OFFSHORE_CAPACITY and OFFSHORE_CAPACITY_GW map to same value
      const offshoreCapacity = Math.round(data.metrics.offshoreCapacityByStake).toString();
