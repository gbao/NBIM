...
class DashboardGenerator {
  ...
  async generateDashboardHtml(data) {
    ...
    try {
      ...
      // Replace template variables - Optimized single pass replacement
      // Performance optimization: Using a map and single regex replaces O(N*M) with O(N) complexity
      const replacements = {
      ...
      // Use a callback function to avoid special replacement patterns (like $&) in the replacement string
