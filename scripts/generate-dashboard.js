...
class DashboardGenerator {
  ...
  async generateDashboardHtml(data) {
    ...
    try {
      ...
      // Optimization: Using single-pass regex replacement instead of chained .replace() calls
      // This is more efficient as it iterates through the template string only once
      const replacements = {
      ...
      return template.replace(/{{[A-Z0-9_]+}}/g, match => {
