...
class DashboardGenerator {
  ...
  async generateDashboardHtml(data) {
    ...
    try {
      ...
      // Performance optimization: Use a single pass replacement instead of chained .replace()
      // This is O(N) instead of O(N*M) where N is template size and M is number of replacements
      const replacements = {
