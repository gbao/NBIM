...
class DashboardGenerator {
  ...
  async generateDashboardHtml(data) {
    ...
    try {
      ...
      // Replace template variables - Optimized with single-pass regex strategy
      // This reduces template traversal from O(N*M) to O(N) where M is number of replacements
      const replacements = {
