...
class DashboardGenerator {
  ...
  async generateDashboardHtml(data) {
    ...
    try {
      ...
      // ⚡ Bolt Optimization: Use a single lookup map instead of chained .replace() calls
      // This improves performance significantly by parsing the template string only once
      const replacements = {
