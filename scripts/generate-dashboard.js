...
class DashboardGenerator {
  ...
  async generateDashboardHtml(data) {
    ...
    try {
      ...
      // Performance optimization: Using a regex with a callback function avoids creating
      // intermediate strings for each replacement (O(N) instead of O(N*M)) and
      // prevents bugs where replacement values containing special characters (like '$')
      // are misinterpreted by String.prototype.replace.
